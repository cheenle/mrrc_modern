...
Run the full suite with `python -m unittest discover -s tests -v` (currently 724 tests across 39 modules). At minimum: `python -m py_compile *.py`. Hardware-dependent changes should document: connecte
