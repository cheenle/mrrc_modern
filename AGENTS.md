...
Run the full suite with `python -m unittest discover -s tests -v` (currently 1186 tests across 60 modules). At minimum: `python -m py_compile *.py`. Hardware-dependent changes should document: connecte
