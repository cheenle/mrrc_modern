...
`MRRC-Modern-v1.18.1-arm64.dmg`（55,643,537 bytes，SHA-256 `931b312c…`）。

**校验下载完整性（可选，命令行）**：

```bash
shasum -a 256 ~/Downloads/MRRC-Modern-v1.18.1-arm64.dmg
```
...
1. 双击打开 `MRRC-Modern-v1.18.1-arm64.dmg`。
