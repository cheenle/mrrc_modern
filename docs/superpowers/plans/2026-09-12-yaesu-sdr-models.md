...
```bash
git add backends/ tests/ config.py server.py _diag_yaesu.py \
        docs/ README.md AGENTS.md DEPENDENCIES.md SDD/ && \
  git commit -m "chore(yaesu): final wiring and verification pass
