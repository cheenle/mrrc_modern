...
#
# macOS menu-bar launcher for MRRC FT-710.
#
...
#
# This spec produces a bare onefile executable named MRRC-FT710. build.sh then
# hand-assembles the .app bundle (Contents/Info.plist + Contents/MacOS/...).
# We deliberately do NOT use PyInstaller's BUNDLE target: onefile + BUNDLE is
# deprecated ("clashes with macOS's security") and produces a malformed bundle.
#
# The runtime files (ft710-server onedir, scope_pipe, default.env,
