...
no serial port, no USB audio device needed. 919 tests across 45 test modules.
...
| -------- | ------- |
| Total tests | 919 |
| Passed | 919 (with all optional dependencies installed) |
...
2. **Fast execution**: ~919 tests in ~15s — can run on every commit.
