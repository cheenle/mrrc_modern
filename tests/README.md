...
1224 tests across 62 test modules (7 pty-based Yaesu round-trip tests skip on
...
| -------- | ------- |
| Total tests | 1224 |
| Passed | 1224 (with all optional dependencies installed; 1 skipped) |
...
2. **Fast execution**: ~1224 tests in ~24s — can run on every commit.
